...
# MediaPresence - Discord Rich Presence script for XBMC4Xbox / XBMC4Gamers (and possibly XBMC360). For use with Mobcat/MrMilenko's "xbdStats" server. To use on startup, add xbmc.executebuiltin("XBMC.RunScript(Q:/scripts/MediaPresence/default.py)") to "autoexec.py" in your XBMC "scripts" folder (usually Q:/scripts) ] 
